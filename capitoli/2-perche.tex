...
\begin{figure}[H]
    ...
    \caption{Confronto \textit{backend} e \textit{frontend}. Fonte: \href{https://dharmanikheem.medium.com/front-end-vs-back-end-what-is-the-difference-9a83a65ee74f}{Medium}}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Infografica che evidenzia quanto sia fondamentale l'equilibrio vita-lavoro. Fonte: \href{https://www.bitboss.it/developers-hub/the-state-of-development-in-italy/2022}{bitboss}}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Infografica utilizzo applicazioni \textit{mobile} rispetto a \textit{desktop} e \textit{tablet}. Fonte: \href{https://gs.statcounter.com/platform-market-share/desktop-mobile-tablet}{statcounter}}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Ikea sperimenta con la realtà aumentata per vendere mobilia, Nintendo per scopi ludici. Fonti: \href{https://www.ikea.com/au/en/customer-service/mobile-apps/say-hej-to-ikea-place-pub1f8af050}{Ikea}, \href{https://vrscout.com/news/nintendo-president-says-company-exploring-ar/}{VRScout}}
\end{figure}
