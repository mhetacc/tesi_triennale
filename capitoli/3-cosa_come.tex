...
\begin{lstlisting}[language=dart, label={lst:android_channels}, firstnumber=1,caption={Android chiamate dei \textit{method channel} per effettuare \textit{create, delete, ulpoad, delete cloud anchor} tramite \textit{method channel}}]
...
\begin{lstlisting}[language=dart, label={lst:ios_channels}, firstnumber=1,caption={iOS chiamate dei \textit{method channel} per effettuare \textit{create, delete, ulpoad, delete cloud anchor}}]
...
L'unico requisito rimasto insoddisfatto è il seguente:
{
    ...
    \bottomrule
    \rowcolor{white} 
    \caption{Requisiti soddisfatti dal codice.}
    \end{longtable}
}
