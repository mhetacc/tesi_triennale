...
\begin{figure}[H]
  \centering
  %\includegraphics[height=5cm]{screen_mobilesyn}
  \includegraphics[width=.26\textwidth]{asset_card_onTap}\hfill
  \includegraphics[width=.26\textwidth]{remove_asset}\hfill
  \includegraphics[width=.26\textwidth]{asset_list}
...
\begin{figure}[H]
  \centering
  %\includegraphics[height=5cm]{screen_mobilesyn}
  \includegraphics[width=.26\textwidth]{ticket_ar1}\hfill
  \includegraphics[width=.26\textwidth]{ticket_ar2}\hfill
  \includegraphics[width=.26\textwidth]{asset_with_ticket}
