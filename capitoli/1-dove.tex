...
\begin{figure}[ht]
    \centering
    \includegraphics[height=4cm]{screenshot_home_datasoil}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=2.5cm]{continuous-delivery-pipeline}
...
\begin{figure}[h]
    \centering
    \includegraphics[height=3.5cm]{asa_github_screen}
