...
\begin{figure}[ht]
    \centering
    \includegraphics[height=4cm]{datasoil_assets_3dmap}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=4cm]{metriche_asset_datasoil}
    \caption{Visualizzazione grafica metriche di controllo per \textit{asset} aziendale. Fonte: \href{https://datasoil.it/industry-40-smartcity-syn-asset-performance/monitoraggio-asset/}{Datasoil}}
\end{figure}\aCapo{}
