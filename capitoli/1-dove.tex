...
\begin{figure}[H]
    ...
    \caption{L'immagine scelta dall'azienda per il proprio sito mostra una chiara direzione aziendale. Fonte: \href{https://datasoil.it/industry-40-smartcity-syn-asset-performance/}{https://datasoil.it/industry-40-smartcity-syn-asset-performance/}}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\textit{Continuous delivery pipeline} tramite Jira. Fonte: \href{https://www.atlassian.com/continuous-delivery}{https://www.atlassian.com/continuous-delivery}}
\end{figure}
...
Nella "Stack Overflow 2021 Developer Survey", \vsc{} è risultato essere l'IDE più popolare, adottato dal 70\% degli intervistati. {\tiny Fonte: \href{https://en.wikipedia.org/wiki/Visual_Studio_Code}{https://en.wikipedia.org/wiki/Visual_Studio_Code}}\\
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{HoloLens usato in azienda per gestire \textit{asset} in realtà aumentata. Fonte: \href{https://datasoil.it/industry-40-smartcity-syn-asset-performance/auditing-inventory/}{https://datasoil.it/industry-40-smartcity-syn-asset-performance/auditing-inventory/}}
\end{figure}
