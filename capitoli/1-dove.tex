...
\begin{figure}[H]
    ...
    \caption{L'immagine scelta dall'azienda per il proprio sito mostra una chiara direzione aziendale. Fonte: \url{https://datasoil.it/industry-40-smartcity-syn-asset-performance/}}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{\textit{Continuous delivery pipeline} tramite Jira. Fonte: \url{https://www.atlassian.com/continuous-delivery}}
\end{figure}
...
Nella "Stack Overflow 2021 Developer Survey", \vsc{} è risultato essere l'IDE più popolare, adottato dal 70\% degli intervistati. {\tiny Fonte: \url{https://en.wikipedia.org/wiki/Visual_Studio_Code}}\\
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{HoloLens usato in azienda per gestire \textit{asset} in realtà aumentata. Fonte: \url{https://datasoil.it/industry-40-smartcity-syn-asset-performance/auditing-inventory/}}
\end{figure}
